...
import (
	...
	"github.com/The-Cipher-Protocol/cipher-node/cmd/server/config"
	"github.com/The-Cipher-Protocol/cipher-node/cmd/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the NETH client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing NETH client data",
	)
