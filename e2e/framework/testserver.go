...
import (
	...
	ibftSwitch "github.com/The-Cipher-Protocol/cipher-node/cmd/chp/switch"
	"github.com/The-Cipher-Protocol/cipher-node/cmd/genesis"
	"github.com/The-Cipher-Protocol/cipher-node/cmd/genesis/predeploy"
	initCmd "github.com/The-Cipher-Protocol/cipher-node/cmd/secrets/init"
	"github.com/The-Cipher-Protocol/cipher-node/cmd/server"
	"github.com/The-Cipher-Protocol/cipher-node/consensus/ciphero/fork"
	ibftOp "github.com/The-Cipher-Protocol/cipher-node/consensus/ciphero/proto"
	...
	stakingHelper "github.com/The-Cipher-Protocol/cipher-node/utils/helper/staking"
	"github.com/The-Cipher-Protocol/cipher-node/utils/helper/tests"
	txpoolProto "github.com/The-Cipher-Protocol/cipher-node/utils/txpool/proto"
	"github.com/The-Cipher-Protocol/cipher-node/validators"
)
...
func (t *TestServer) SecretsInit() (*InitIBFTResult, error) {
	...
	args = append(args, "--datadir", filepath.Join(t.Config.IBFTDir, "tmp"))
...
func (t *TestServer) Start(ctx context.Context) error {
	...
	switch t.Config.Consensus {
	case ConsensusIBFT:
		args = append(args, "--datadir", filepath.Join(t.Config.RootDir, t.Config.IBFTDir))
	case ConsensusDev:
		args = append(args, "--datadir", t.Config.RootDir)
